...
def crearObjetos(thief:pygame.Surface, checkPoint:pygame.Surface):
    ...
    return thiefrect, checkPointrect
...
def movimiento(thief, checkPoint, keys:int, clicks:Tuple, thiefrect:pygame.Rect, screen:pygame.Surface):
    if keys:
        if (keys == 1):
    ...
    if clicks:
        ...
        # if obstaculoNuevo and obstaculoNuevorect:
        #     screen.blit(obstaculoNuevo, obstaculoNuevorect)
...
def main():
    ...
    llenarFondo(screen)
    thiefrect, checkPointrect = crearObjetos(thief, checkPoint)
...
# Eventos
        ...
        if keys or clicks:
            thiefrect = movimiento(thief, checkPoint, keys, clicks, thiefrect, screen)
# Eventos
